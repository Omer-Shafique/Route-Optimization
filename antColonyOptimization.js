    ...
    try {
        ...
        for (var i = 1; i < lines.length; i++) {
            ...
            if (line !== '') {
                ...
                coordinates.push({ lat: latitude, lng: longitude, name: locationName, priority: isPriority, rowIndex: i });
        ...
        // Sort coordinates array such that the starting point is at the beginning
